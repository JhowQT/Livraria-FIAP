...
export WEBAPP_NAME="movtodimdim-rm559597"
...
export GITHUB_REPO_NAME="JhowQT/Livraria-FIAP"
export BRANCH="main"
...
az webapp config appsettings set \
  ...
  --settings \
    ...
    SPRING_DATASOURCE_URL="jdbc:sqlserver://sqlserver-rm559597.database.windows.net:1433;database=dimdimdb;user=admsql@sqlserver-rm559597;password=Fiap@2tdsvms;encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;"
